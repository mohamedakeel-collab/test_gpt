...
All skills in `.Codex/skills/` are available. Ensure you've internalized:
...
State:
- **AsyncCubit<T>** (in `core/state/async/`) for fetched data — extends `AsyncCubit<T>`, takes **UseCases** in the constructor (`@injectable`).
