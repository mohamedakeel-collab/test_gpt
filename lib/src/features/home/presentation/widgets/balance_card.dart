...
class _BalanceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final remaining = isManager
        ? user.remainingLeaveBalance
        : home.remainingLeaveBalance;

    final total = isManager? user.leaveBalance:home.employee?.leaveBalance ?? remaining;
          ...
          Stack(
            ...
            children: [
              ...
              Text(
                ...
                style: const TextStyle().setPrimaryColor.s14.bold,
              ),
            ],
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle().setPrimaryColor.s32.bold,
                ),

                Text(
                  LocaleKeys.balanceTitle(count: '$total'),

                  style: const TextStyle().setWhiteColor.s14.regular,
                ),
              ],
            ),
          ),
