...
class _RequestCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Go.to(OrderDetailsScreen(id: request.id)),
      child: Container(
        ...
        child: Row(
          children: [
            ...
            12.szW,
            ConstrainedBox(
              constraints: BoxConstraints(maxWidth: AppSize.sW90),
...
class _RequestStatusBadge extends StatelessWidget {
  const _RequestStatusBadge({required this.status, required this.statusText});
